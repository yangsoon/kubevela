...
func TrackDeployStatus(c common.Args, appName string, env *types.EnvMeta) (CompStatus, string, error) {
	...
	if appObj.Status.Phase == common.ApplicationRunning {
		return compStatusDeployed, "", nil
	}
...
func getWorkloadStatusFromApp(app *v1alpha2.Application, compName string) (common.ApplicationComponentStatus, bool) {
	foundWlStatus := false
	wlStatus := common.ApplicationComponentStatus{}
	if app == nil {
